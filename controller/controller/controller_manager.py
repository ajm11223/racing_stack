...
class ControllerManager(Node):
    ...
    def __init__(self):
        ...
        # optional MAP-style chord-cap on the pure-PP L1 (bool, default OFF ->
        # byte-identical pure-Pursuit behaviour). l1_chord_err (its magnitude)
        # is a float in L1_PARAMS above.
        self.use_chord_cap = bool(self._get_param('use_chord_cap', False))
    ...
    def global_wpnts_cb(self, data: WpntArray):
        ...
        self.controller = Controller(
            ...
            use_chord_cap=self.use_chord_cap,
    ...
    def dyn_param_cb(self, params):
        ...
        for param in params:
            ...
            elif name == 'use_chord_cap':
                self.use_chord_cap = bool(param.value)
                if self.controller is not None:
                    self.controller.use_chord_cap = self.use_chord_cap
    ...
    def save_yaml(self):
        ...
        try:
            ...
            params['use_chord_cap'] = bool(self.use_chord_cap)   # chord-cap toggle
